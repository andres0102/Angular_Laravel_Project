...
class payroll_2019_11 extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $batch_summary = [
            ...
            'feeds' => [
              ...
              PayrollHelper::generate_feed('lfa', 'manulife', $payroll_year . '-' . $payroll_month . '---lfa-manulife.xlsx', 'life', 2),
               ...
               */
              PayrollHelper::generate_feed('lfa', 'aviva', '2019-11---lfa-aviva-health-life-batch-cindy.xlsx', 'health-life'),
              PayrollHelper::generate_feed('lfa', 'axa', '2019-11---lfa-axa-health-life-batch-cindy.xlsx', 'health-life', 2),
            ]
        ];

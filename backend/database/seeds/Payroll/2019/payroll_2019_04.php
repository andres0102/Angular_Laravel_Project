...
class payroll_2019_04 extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $batch_summary = [
            ...
            'feeds' => [
              ...
              /** ==========================================================
               *  Previous months discrepancies
               */
              PayrollHelper::generate_feed('gi', 'liberty', '2019-03---gi-liberty-outstanding.xlsx', 'gi'),
              PayrollHelper::generate_feed('gi', 'msig', '2019-03---gi-msig-outstanding.xlsx', 'gi'),
              PayrollHelper::generate_feed('gi', 'sompo', '2019-03---gi-sompo-outstanding.xlsx', 'gi'),
              PayrollHelper::generate_feed('lfa', 'tm', '2019-03---lfa-tm-go.xlsx', 'group-override'),
            ]
        ];

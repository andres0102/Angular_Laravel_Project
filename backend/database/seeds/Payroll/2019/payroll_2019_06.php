...
class payroll_2019_06 extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $batch_summary = [
            ...
            'feeds' => [
              ...
              PayrollHelper::generate_feed('lfa', 'manulife', $payroll_year . '-' . $payroll_month . '---lfa-manulife-life.xlsx', 'life', 1),
               ...
               */
              PayrollHelper::generate_feed('lfa', 'tm', '2019-01---lfa-tm-go.xlsx', 'group-override'),
              PayrollHelper::generate_feed('lfa', 'tm', '2019-02---lfa-tm-go.xlsx', 'group-override'),
            ]
        ];

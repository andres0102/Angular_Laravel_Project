...
class Ajaxify
{
    ...
    /*
    Finally Register this middleware as a global middleware, by going to this file app/Http/Kernel.php.
    ...
    Now you can try sending an Ajax request to your existing route
    or just try this in your browser: http://yourapp.dev?ajaxify

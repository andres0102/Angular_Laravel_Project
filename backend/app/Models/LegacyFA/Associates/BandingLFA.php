...
class BandingLFA extends BaseModel
{
    /** ===================================================================================================
    ...
    public static function boot()
    {
        ...
        self::created(function ($model) {
            ...
            $associate->log(auth()->user(), 'banding_lfa_created', 'LFA Banding record created.', null, $model, 'banding_lfa', $model->uuid);
        });
    }
}
